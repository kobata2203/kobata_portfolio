...
<body>
     ...
     <div class="container">
        <div class="text-center mt-5">
            <h1>キャリアプラン</h1>
            <p class="lead">①Webエンジニアとして経験を積む</p>
            <p class="lead">②PLとしてプロジェクトのタスク管理をする</p>
            <p class="lead">③PMとしてプロジェクト全体のマネジメントをする</p>
            <p class="lead">④ロボットプログラミング技術を修得する</p>
            <p class="lead">⑤ロボットプログラミング教室を開校する</p>
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="https://www.expo2025.or.jp/wp/wp-content/themes/expo2025orjp_2022/assets/img/expo-map-index/map/img02.jpg" alt="..." /></div>
                <div class="col-lg-5">
