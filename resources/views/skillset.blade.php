...
<body>
     ...
     <div class="container">
        <div class="text-center mt-5">
            <h1>スキルセット</h1>
            <p class="lead">言語：PHP　html　css　bootstrap　Javascript　フレームワーク：Laravel　データベース：MySQL　開発環境：Docker　WSL2</p>
            <p class="lead">対応フェーズ：要件定義　基本設計　詳細設計　実装　テスト　デプロイメント　運用・保守</p>
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="https://www.expo2025.or.jp/wp/wp-content/themes/expo2025orjp_2022/assets/img/expo-map-index/map/img01.jpg" alt="..." /></div>
                <div class="col-lg-5">
